    ...
    function getContext($list){
        ...
        <h3 class="mt-3">Нулевая Аттестация</h3>
            ...
            <div class="con">
                        ...
                        <form class="needs-validation" novalidate="" action="zero" method="POST">
                ...
                <div class="wrapper">Астрономия
                    ...
                    <input type="hidden" name="create" value="zero">
            </form>
       ...
       <table class="table-fixed-head">
            ...
            <?php foreach($this->arr as $el):?>
                <tr>
                    ...
                    <td><?=$el['astronomy']?></td>
                    <td>
                        <form action='zero' class="delete" method="POST">
                            <input type="hidden" name="delete" value="zero">
