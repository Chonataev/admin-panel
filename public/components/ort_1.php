...
class ort_1
{
    ...
    function getContext($list){
        ...
        <div class="container">
            ...
            <form class="needs-validation" novalidate="" action="ort_1" method="POST">
                ...
                <div class="container1">
                    ...
                    <input type="hidden" name="create" value="ort_1"></form>
                    ...
                    <tr>
                        ...
                        <td>
                           <form action="ort_1" method="POST">
                            ...
                            <td><form action='ort_1' class="delete" method="POST">
                                <input type="hidden" name="delete" value="ort_1">
                                <input type="hidden" name="id" value=<?=$el['id']?>>
