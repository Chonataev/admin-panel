...
class Quarter_1
{
    ...
    function getContext($list){
        ...
        <div class="container">
            ...
            <div class="con">
                <form action="quarter_1" method="post">
            ...
            <form class="needs-validation" novalidate="" action="quarter_1" method="POST">
                ...
                <div class="container1">
                    ...
                    <input type="hidden" name="create" value="quarter_1">
            ...
            <table class="table-fixed-head">
                ...
                <?php foreach($this->arr as $el):?>
                    <tr>
                        ...
                        <td>
                            <form action='quarter_1' class="delete" method="POST">
                                <input type="hidden" name="delete" value="quarter_1">
