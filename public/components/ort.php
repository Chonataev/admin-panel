...
class ort
{
    ...
    function getContext($list){
        ...
        <div class="container">
            ...
            <form class="needs-validation" novalidate="" action="ort" method="POST">
                ...
                <div class="container1">
                    ...
                    <input type="hidden" name="create" value="ort"></form>
            ...
            <table class="table-fixed-head">
                ...
                <?php foreach($this->arr as $el):?>
                    <tr>
                        ...
                        <td><form action='ort' class="delete" method="POST">
                                <input type="hidden" name="delete" value="ort">
                                <input type="hidden" name="id" value=<?=$el['id']?>>
