...
class srs
{
    ...
    function getContext($list){
        ...
        <div class="container">
            ...
            <form class="needs-validation" novalidate="" action="srs " method="POST">
                ...
                <input type="hidden" name="create" value="srs">
            ...
            <table class="table-fixed-head">
                ...
                <?php foreach($this->arr as $el):?>
                    <tr>
                        ...
                        <td>
                            <form action='srs' class="delete" method="POST">
                                <input type="hidden" name="delete" value="srs">
